...
const { text } = await generateText({
  ...
  system: [
    ...
    "addresses that make the decision auditable. For every attestation",
    "address in your tool results, present it as an Examiner View link:",
    "https://permitr.vercel.app/a/<attestation>. Plain English, precise,",
